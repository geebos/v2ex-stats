        ...
        <div className="bg-white rounded-lg shadow-lg">
          ...
          <div className="px-6 py-3 border-b border-gray-200 bg-blue-600 flex items-center justify-between">
            ...
            <a
              ...
              className="flex items-center gap-1.5 bg-white/15 hover:bg-white/25 transition-colors rounded-lg px-3 py-1.5 text-white text-sm"
            >
